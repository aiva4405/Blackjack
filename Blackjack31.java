 ...
 * 
 * A variant of Blackjack where the max score before busting is 31 rather than 21
 * otherwise the code is the exact same as the BlackjackGame class
 */
...
public class Blackjack31{
    ...
    private static Dealer dealer = new Dealer(31);
    ...
    public static void main(String[] args){
        ...
        for(int i = 1; i <= playerCount; i++){
            Player newPlayer = new Player(i, 31);
